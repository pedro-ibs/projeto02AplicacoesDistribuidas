...
import br.edu.livros.acervo.repository.Categorypository;

@Service
public class CategoryServices {
	
	@Autowired
	Categorypository repository;
	...
	public CategoryVO update(CategoryVO category) {
		var entity = repository.findById(category.getId()).orElseThrow(() -> new ResourceNotFoundException ("Não encontramos registros para este ID"));
